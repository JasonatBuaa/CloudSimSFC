...
public class Vm {
	 ...
	 * @param size              The size the VM image size (the amount of storage it
	...
	/**
	 * Gets total CPU utilization percentage of all clouddlets running on this VM at
	 * the given time
	 * 
	 * @param time the time
	...
	/**
	 * Get total CPU utilization of all cloudlets running on this VM at the given
	 * time (in MIPS).
	 * 
	 * @param time the time
