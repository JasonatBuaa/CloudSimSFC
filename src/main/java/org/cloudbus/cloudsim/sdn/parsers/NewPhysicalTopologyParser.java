 ...
 */
public class NewPhysicalTopologyParser {
	...
	public NewPhysicalTopologyParser(String jsonFilename, HostFactory hostFactory) {
	...
	public static void loadPhysicalTopologySingleDC(String physicalTopologyFilename, NetworkOperatingSystem nos,
		...
		NewPhysicalTopologyParser parser = new NewPhysicalTopologyParser(physicalTopologyFilename, hostFactory);
		parser.parse(nos);
