 ...
 */
public class SFCWorkloadGenerator extends VirtualTopologyGeneratorVmTypesSFC {
    ...
    public double randomDouble(int baseNum) {
        ExponentialDistr dis = new ExponentialDistr(baseNum);
        return dis.sample();
    }
