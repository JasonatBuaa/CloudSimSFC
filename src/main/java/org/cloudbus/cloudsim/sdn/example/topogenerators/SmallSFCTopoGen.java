...
/**
 * Experimental Topology for Demo: -- 3 tier -- Size Web->3, App->2, DB->2
 */
public class SmallSFCTopoGen extends VirtualTopologyGeneratorVmTypes {

    public static void main(String[] argv) {
        SmallSFCTopoGen vmGenerator = new SmallSFCTopoGen();
        boolean noscale = true;
        vmGenerator.generateLarge3TierTopologySFC("WithFaultsSmallSFC.json", noscale);
    }
    ...
    public VMSpec createVM(VMtype vmtype, double startTime, double endTime, int vmGroupId, int vmGroupSubId,
        ...
        switch (vmtype) {
            ...
            case AppServer:
                // m2.xlarge
                mips = 3000;// (long) (mips*2.5);
                pes = 4;
                name = "app";
                break;
            case DBServer:
                // c1.xlarge
                mips = 1500;// (long) (mips*2.5);
                pes = 12;
                name = "db";
                break;
            case Proxy:
