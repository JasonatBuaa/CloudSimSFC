...
/**
 * This class specifies different type of VMs that will be generated from
 * VirtualTopoGenerator. Please change the configurations of VMs (MIPs,
 * bandwidth, etc) here.
 * 
 * @author Jungmin Son
...
public class VirtualTopologyGeneratorVmTypes extends VirtualTopologyGenerator {
	...
	public void generateLarge3TierTopologyFullNetwork(String jsonFileName) {
		...
		final int vmNum = 16;
		final Long[] linkBW = new Long[] { 125000000L / 2, -1L, -1L, -1L, -1L, -1L, -1L, -1L, -1L, -1L, -1L, -1L, -1L,
	...
	public void generateLarge3TierTopology(String jsonFileName) {
		...
		final Long[] linkBW = new Long[] { 125000000L / 2, 125000000L / 4, 125000000L / 8, 125000000L / 8,
				125000000L / 8, 125000000L / 8, 125000000L / 8, 125000000L / 8, 125000000L / 8, 125000000L / 8,
				125000000L / 8, 125000000L / 8, 125000000L / 8, 125000000L / 8, 125000000L / 8 };
	...
	public void generateVMGroup(int numVMsInGroup, double startTime, double endTime, Long linkBw, int groupId,
			int subGroupId) {
