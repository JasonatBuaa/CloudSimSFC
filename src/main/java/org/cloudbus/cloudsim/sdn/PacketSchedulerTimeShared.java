...
//        return jitter.sampleTransmissionPerformance(channel.getAllocatedBandwidth(), this.channel);
        return jitter.sampleTransmissionPerformancePercentage(channel.getAllocatedBandwidth(), this.channel);
