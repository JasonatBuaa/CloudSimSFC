...
/**
 * VM Allocation Policy - Availability -.
 * Use the availability value for VM selection.   
 */
public class VmAllocationPolicyAvailability extends VmAllocationPolicyEx implements VmAllocationInGroup {
	public VmAllocationPolicyAvailability(List<? extends Host> list, HostSelectionPolicy hostSelectionPolicy,
