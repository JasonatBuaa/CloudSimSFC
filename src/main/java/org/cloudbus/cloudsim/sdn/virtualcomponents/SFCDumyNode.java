...
public class SFCDumyNode extends ServiceFunction {
    ...
    public SFCDumyNode(int id, int userId, CloudletScheduler cloudletScheduler, double start_time, double end_time, String nodeType) throws Exception {
        super(id, userId, mips, numberOfPes, ram, bw, size, vmm, cloudletScheduler,start_time,end_time, availability,queueSize);
