...
public class StaticSchedulerScenario4 extends DeploymentScheduler {
    ...
    public StaticSchedulerScenario4(List<ServiceFunctionChain> serverFunctionChains, List<SFCWorkload> sfcWorkloads,
    ...
    public void generateLinks(List<ServiceFunctionChain> serverFunctionChains) {
        generateLinksForScenario4_1(serverFunctionChains);
    ...
    public void generateLinksForScenario4_1(List<ServiceFunctionChain> serverFunctionChains) {
