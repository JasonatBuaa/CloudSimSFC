...
public class CompScenarioParser {
...
//    private List<SFCWorkloadForSDNNFV> sfcWorkloadsForCloudSimSDNNFV;
    ...
    public void setRootPath(String folder) {
        ...
        CompScenarioParser.prepareFolder(this.rootPath);
        CompScenarioParser.prepareFolder(this.workloadFolder);
        CompScenarioParser.prepareFolder(this.compSDNNFVRootPath);
    }

    public CompScenarioParser() {
        this.sfcWorkloads = new ArrayList<>();
        prepareSubFolders();
    }

    public CompScenarioParser(String rootFolder, String subFolder) {
        this.sfcWorkloads = new ArrayList<>();
        this.rootPath = rootFolder + subFolder;
        CompScenarioParser.prepareFolder(this.rootPath);

        this.workloadFolder = rootPath + "workloads/";
        CompScenarioParser.prepareFolder(workloadFolder);
...
//        int SFCDemandNUM = 20;
        ...
        for (int i = 1; i <= SFCDemandNUM; i++) {
            int chainlen = (int) (Math.random() * 3) + 1;
...
//            String folder = workloadFolder + "sdnnfv/";
            ...
            CompScenarioParser.prepareFolder(folder);
