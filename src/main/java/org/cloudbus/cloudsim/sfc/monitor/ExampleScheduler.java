...
public class ExampleScheduler extends DeploymentScheduler {
    ...
    public ExampleScheduler(ServiceFunctionChain needSchedule, MonitorImpl monitor, List<ServiceFunctionChain> serverFunctionChains, List<SFCWorkload> sfcWorkloads,
    ...
    @Override
    public void generateNodes(List<SFCWorkload> sfcWorkloads, List<Resource> resources, List<ServiceFunctionChain> serviceFunctionChains) {
        scheduleByGreedy();
    }
    ...
    public void scheduleByGreedy() {
        ...
        for (; index < chain.size();) {
            ...
            for (ServiceFunction serviceFunction : serviceFunctionTogether) {
                ...
                nodes.add(new VirtualTopologyVmSF(sfInstanceName, serviceFunction.getName(), 1000, 1, 500, 128, selectDc));
            }
        }
    }
