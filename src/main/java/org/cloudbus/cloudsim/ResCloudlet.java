...
public class ResCloudlet {
	...
	/**
	 * Cloudlet execution start time. This attribute will only hold the latest time
	 * since a Cloudlet can be canceled, paused or resumed.
	 */
	...
	/**
	 * Allocates a new ResCloudlet object upon the arrival of a Cloudlet object. Use
	 * this constructor to store reserved Cloudlets, i.e. Cloudlets that done
	 * reservation before. The arriving time is determined by
	 ...
	 * owner.
	 * 
	 * @param wallClockTime the time of this Cloudlet resides in a CloudResource
	 ...
	 * @post $none
	 * 
	 * @todo the machineId param and attribute mean a VM or a PM id? Only the term
	 *       machine is ambiguous. At
	...
	/**
	 * Gets the remaining cloudlet length that has to be execute yet, considering
	 * the {@link #getCloudletTotalLength()}.
	 * 
